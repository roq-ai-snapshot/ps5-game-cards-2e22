...
function TransactionViewPage() {
  ...
  const queryParams = useMemo<{ include: { user: boolean; game_card: boolean } }>(
    () =>
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Billing Address" text={data?.billing_address} />

                <FormListItem label="Shipping Address" text={data?.shipping_address} />
