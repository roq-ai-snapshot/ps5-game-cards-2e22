...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`PS5 Game Cards`}</title>

        <meta
          name="description"
          content="Welcome to PS5 Game Cards, your ultimate platform for building a unique digital game cards collection. Elevate your gaming experience with us."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxQUzV8ZW58MHx8fHwxNjk5MDY5MTE2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@kseverin?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Kerde Severin`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to PS5 Game Cards, your ultimate platform for building a unique digital game cards collection. Elevate your gaming experience with us.`}
            </Text>
            <Box
