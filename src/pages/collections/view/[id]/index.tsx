...
import { useCollectionFindFirst, useRoqClient } from 'lib/roq';
...
function CollectionViewPage() {
  ...
  const { data, error, isLoading } = useCollectionFindFirst(queryParams, {}, { disabled: !id });
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Total Cards" text={data?.total_cards} />
                ...
                <FormListItem
                  label="Last Updated Card"
                  text={data?.last_updated_card ? format(data?.last_updated_card, 'dd-MM-yyyy') : ''}
                />
