...
import { useGameCardFindFirst, useRoqClient } from 'lib/roq';

import { GameCardInterface } from 'interfaces/game-card';
import { CollectionCardListPage } from 'pages/collection-cards';
import { TransactionListPage } from 'pages/transactions';

function GameCardViewPage() {
  ...
  const { data, error, isLoading } = useGameCardFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('game_card', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/game-cards/edit/${id}`} passHref legacyBehavior>
                    <Button
