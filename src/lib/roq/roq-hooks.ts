...
export function useCollectionFindMany<
...
>(
  ...
  const key = JSON.stringify(['useCollectionFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.collection.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useCollectionCount<T extends Prisma.collectionCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.collectionCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useCollectionCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.collection.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useCollectionFindManyWithCount<
  T extends Prisma.collectionFindManyArgs,
  R extends { data: GetFindResult<Prisma.$collectionPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.collectionFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useCollectionFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.collection.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useCollectionFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useCollectionFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.collection.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useCollectionCardFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useCollectionCardFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.collection_card.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useCollectionCardCount<T extends Prisma.collection_cardCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.collection_cardCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useCollectionCardCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.collection_card.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useCollectionCardFindManyWithCount<
  T extends Prisma.collection_cardFindManyArgs,
  R extends { data: GetFindResult<Prisma.$collection_cardPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.collection_cardFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useCollectionCardFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.collection_card.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useCollectionCardFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useCollectionCardFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.collection_card.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useGameCardFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useGameCardFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.game_card.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useGameCardCount<T extends Prisma.game_cardCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.game_cardCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useGameCardCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.game_card.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useGameCardFindManyWithCount<
  T extends Prisma.game_cardFindManyArgs,
  R extends { data: GetFindResult<Prisma.$game_cardPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.game_cardFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useGameCardFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.game_card.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useGameCardFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useGameCardFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.game_card.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
